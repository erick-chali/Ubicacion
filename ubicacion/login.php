...
class clogin extends c_Users {
	...
	function __construct() {
		...
		// Table object (_Users)
		if (!isset($GLOBALS["_Users"]) || get_class($GLOBALS["_Users"]) == "c_Users") {
			$GLOBALS["_Users"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["_Users"];
		}
		if (!isset($GLOBALS["_Users"])) $GLOBALS["_Users"] = &$this;
