...
function ew_AutoLoad($class) {
	...
	if (substr($class, 0, 1) == "c") {
		if ($class == "cMillenium_db") {
			$file = "Milleniumdb.php";
		} else {
		$fn = "%cls%info.php";
...
function CurrentProjectID() {
	...
	return "{61E4280F-6622-4502-933A-764E36139766}";
}
...
?>
<?php
include_once($EW_RELATIVE_PATH . 'phpexcel180/Classes/PHPExcel.php');
...
function &ew_Connect($info = NULL) {
	...
	if (!$info) {
		$info = "Provider=SQLNCLI11;Persist Security Info=False;Data Source=186.64.110.212;Initial Catalog=PbMillenium2;User Id=consultas;Password=consultas*;DataTypeCompatibility=80"; // ADO connection string
	}
