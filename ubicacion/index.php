...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'in_seccionestanteria'))
		$this->Page_Terminate("in_seccionestanterialist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'in_bodegas'))
			$this->Page_Terminate("in_bodegaslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'in_bodegaubicaciones'))
			$this->Page_Terminate("in_bodegaubicacioneslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'in_estanteria'))
			$this->Page_Terminate("in_estanterialist.php");
