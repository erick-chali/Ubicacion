...
define("EW_PROJECT_ID", "{61E4280F-6622-4502-933A-764E36139766}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'WcRZ9J0zdrcvC76O', TRUE); // Random key for encryption
...
define("EW_IS_MSSQL", TRUE, TRUE); // SQL Server
define("EW_IS_MYSQL", FALSE, TRUE); // MySQL
...
// User table filters
define("EW_USER_TABLE", "[dbo].[_Users]",  TRUE);
...
define("EW_PDF_MEMORY_LIMIT", "500M", TRUE); // Memory limit
